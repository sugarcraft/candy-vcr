...
final class InspectHashSensitivityTest extends TestCase
{
    ...
    {
        $paint = static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', fg: 1, bg: 2));
        };
    ...
    {
        $plain = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', fg: 1, bg: 2));
        });
        $truecolour = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', fg: 1, bg: 2, fgTruecolor: 0x123456));
        });
    ...
    {
        $red = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', fgTruecolor: 0xFF0000));
        });
        $blue = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', fgTruecolor: 0x0000FF));
        });
    ...
    public function testTruecolourBackgroundChangesTheHashIndependentlyOfForeground(): void
    {
        ...
        $truecolourBg = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', fg: 1, bg: 2, bgTruecolor: 0x654321));
        });
        ...
        $red = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', bgTruecolor: 0xFF0000));
        });
        $green = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', bgTruecolor: 0x00FF00));
        });
    ...
    {
        $single = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', rendition: Rendition::None));
        });
        $double = $this->snapshot(static function (Buffer $g): void {
            $g->put(0, 0, new Cell(char: 'X', rendition: Rendition::DoubleWidth));
        });
